...
void test_atomic(void) {
  ...
  _Static_assert(_Generic(k, _Atomic(int): 2, int: 1, default: 0));
}
...
void test_double(void) {
  ...
  _Static_assert(_Generic(pA, double * : 1, default : 0));
  _Static_assert(_Generic(qA, double (*)[3] : 1, default : 0));
  _Static_assert(_Generic(pi, double : 1, default : 0));
}
...
void test_arrary(void) {
  auto a[4];          // expected-error {{declaration of variable 'a' with deduced type 'auto[4]' requires an initializer}}
...
void test_misc(void) {
  ...
  _Static_assert(_Generic(test_char, int : 1, default : 0));
  _Static_assert(_Generic(test_char_ptr, char * : 1, default : 0));
  _Static_assert(_Generic(test_char_ptr2, char * : 1, default : 0));
}
...
void test_compound_literral(void) {
  ...
  _Static_assert(_Generic(c, int : 1, default : 0));
}
...
void test_pointers(void) {
  ...
  auto *ptr2 = a; // expected-error {{variable 'ptr2' with type 'auto *' has incompatible initializer of type 'int'}} \
                     expected-warning {{explicit declaration of 'auto' pointers is a Clang extension}}
  auto nptr = nullptr;

  _Static_assert(_Generic(ptr, int * : 1, default : 0));
  _Static_assert(_Generic(ptr2, int * : 1, default : 0));
}
...
void test_scopes(void) {
  ...
  }
  {
    ...
    _Static_assert(_Generic(a, double : 1, default : 0));
    _Static_assert(_Generic(b, double : 1, default : 0));
  }
}
...
void test_loop(void) {
  ...
  _Static_assert(_Generic(j, int : 1, default : 0));
}
